...
import { getLanguageDirection } from '@/types/i18n';
...
export const metadata: Metadata = {
  ...
  description:
    'A modern todo application with AI-powered chat assistant, authentication, and comprehensive task management. Features OpenAI Agents SDK with MCP (Model Context Protocol) tools for intelligent task operations including add, list, complete, delete, and update tasks through natural conversation.',
  keywords: [
    'todo',
    'task management',
    'AI assistant',
  ...
  openGraph: {
    title: 'Todo App - AI-Powered Task Management',
    description:
      'Manage your tasks with an AI assistant powered by OpenAI Agents SDK and MCP tools. Create, update, complete, and organize tasks through natural conversation.',
    type: 'website',
  },
  twitter: {
    card: 'summary',
    title: 'Todo App - AI-Powered Task Management',
    description:
      'AI assistant with MCP tools for intelligent task management through natural conversation.',
  },
  other: {
    ...
    'chat-features':
      'Real-time streaming, conversation persistence, tool invocation tracking',
  },
};
...
/**
 * Locale-specific layout with next-intl provider
 * Handles language-specific content and RTL support
 */
export default async function LocaleLayout({
  ...
  const direction = getLanguageDirection(locale as Locale);
