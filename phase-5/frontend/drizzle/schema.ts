 ...
 *
 * Generated with: npx @better-auth/cli generate --output drizzle/schema.ts
 *
 * This schema includes all tables required by Better Auth:
 * - user: User accounts
...
/**
 * JWKS table
 * Stores JWT signing keys (required for JWT plugin)
 */
